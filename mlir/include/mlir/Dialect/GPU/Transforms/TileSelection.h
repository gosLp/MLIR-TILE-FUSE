...
// SmallVector<int64_t>
// fitTileSizesToOp(mlir::Operation *op,
...
/// Adapts tile sizes to match the dimensionality of the given operation.
/// This is important when fusing operations with different numbers of loops.
